...
if __name__ == "__main__":
    df_cleaned = pd.read_csv(clean_data_file)
    ...
    # )
    # topics, probs = topic_model.fit_transform(df_cleaned['text'].tolist())
    # topic_model.save("models/bertopic_guyana_min10_with_stopwords")

    ## IF YOU ALREADY HAVE THE MODEL - use this
    model_name = "models/bertopic_guyana_min10_with_stopwords"
